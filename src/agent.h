...
# Author: sk                                                                        #
# Last Modified: Monday, 4th September 2023 12:02:01 pm                             #
...
// SNMP MIB2 System
const char oidSystem[] = ".1.3.6.1.2.1.1.";
/*
...
*/
const char oidDescr[] = "1.0";      // r / str (0...255)
/*
...
*/
const char oidVendor[] = "2.0";     // r / OID (str)
/*
The time (in hundredths of a second) since the network management portion of the system was last re-initialized
*/
const char oidUptime[] = "3.0";     // r / TimeTicks
/*
The textual identification of the contact person
for this managed node, together with information
on how to contact this person.
*/
const char oidContact[] = "4.0";    // rw / str (0...255)
/*
An administratively-assigned name for this
managed node. By convention, this is the node's
fully-qualified domain name
*/
const char oidName[] = "5.0";       // r / str (0...255)
/*
The physical location of this node (e.g.,`telephone closet, 3rd floor')
*/
const char oidLocation[] = "6.0";   // rw / str (0...255)
/*
...
*/
const char oidServiceOSI[] = "7.0"; // r / int (0...127)
...
// UPS System
const char oidEnterprise[] = ".1.3.6.1.4.1.318.1.1.1.";

/*
The UPS model name (e.g. 'APC Smart-UPS 600').
*/
const char upsBasicIdentModel[] = "1.1.1.0";             // r / string
/*
An 8 byte ID string identifying the UPS. This objectcan
be set by the administrator
*/
const char upsBasicIdentName[] = "1.1.2.0";              // rw / string
/*
...
*/
const char upsAdvControlUpsOff[] = "6.2.1.0";            // rw / int /
/*
...
*/
const char upsAdvControlTurnOnUPS[] = "6.2.6.0";         // rw / int
/*
...
*/
const char upsBasicControlConserveBattery[] = "6.1.1.0"; // rw / int
/*
...
*/
const char upsAdvControlSimulatePowerFail[] = "6.2.4.0"; // rw / int
/*
...
*/
const char upsAdvControlFlashAndBeep[] = "6.2.5.0";      // rw / int
/*
...
- switchOutOfBypass         (3)
*/
const char upsAdvControlBypassSwitch[] = "6.2.7.0";      // rw / int
/*
...
- testDiagnostics           (2)
*/
const char upsAdvTestDiagnostics[] = "7.2.2.0";          // rw / int
/*
...
*/
const char upsAdvTestRuntimeCalibration[] = "7.2.5.0";   // rw / int
/*
...
- reset 	(2)
*/
const char upsPhaseResetMaxMinValues[] = "9.1.1.0";      // rw / int
/*
...
*/
const char upsAdvIdentSerialNumber[] = "1.2.3.0";        // r / str
/*
The date when the UPS was manufactured in mm/dd/yy (or yyyy) format.
*/
const char upsAdvIdentDateOfManufacture[] = "1.2.2.0";   // r / str
/*
The current utility line voltage in tenths of VAC
*/
const char upsHighPrecInputLineVoltage[] = "3.3.1.0";    // r / gauge
/*
The maximum utility line voltage in tenths of VAC over the
previous 1 minute period
*/
const char upsHighPrecInputMaxLineVoltage[] = "3.3.2.0"; // r / gauge
/*
The minimum utility line voltage in tenths of VAC over the
previous 1 minute period
*/
const char upsHighPrecInputMinLineVoltage[] = "3.3.3.0"; // r / gauge
/*
The current utility line voltage in VAC.
*/
const char upsAdvInputLineVoltage[] = "3.2.1.0";         // r / gauge
/*
The maximum utility line voltage in VAC over the
previous 1 minute period.
*/
const char upsAdvInputMaxLineVoltage[] = "3.2.2.0";      // r / gauge
/*
The minimum utility line voltage in VAC over the
previous 1 minute period.
*/
const char upsAdvInputMinLineVoltage[] = "3.2.3.0";      // r / gauge
/*
...
*/
const char upsPhaseNumInputPhases[] = "9.2.2.1.2.1"; // r / int
/*
The input voltage in VAC, or -1 if it's unsupported by this UPS
*/
const char upsPhaseInputVoltage[] = "9.2.3.1.3.1.1.1"; // r / int
// const char upsUnknown33[] = "9.2.3.1.3.1.1.2";
// const char upsUnknown34[] = "9.2.3.1.3.1.1.3";
/*
...
*/
const char upsPhaseInputMaxVoltage[] = "9.2.3.1.4.1.1.1"; // r / int
// const char upsUnknown36[] = "9.2.3.1.4.1.1.2";
// const char upsUnknown37[] = "9.2.3.1.4.1.1.3";
/*
...
*/
const char upsPhaseInputMinVoltage[] = "9.2.3.1.5.1.1.1"; // r / int
// const char upsUnknown39[] = "9.2.3.1.5.1.1.2";
// const char upsUnknown40[] = "9.2.3.1.5.1.1.3";
/*
The input current in 0.1 amperes, or -1 if it's unsupported by this UPS.
*/
const char upsPhaseInputCurrent[] = "9.2.3.1.6.1.1.1"; // r / int
// const char upsUnknown42[] = "9.2.3.1.6.1.1.2";
// const char upsUnknown43[] = "9.2.3.1.6.1.1.3";
/*
The maximum input current in 0.1 amperes measured since the last reset (upsPhaseResetMaxMinValues), or
-1 if it's unsupported by this UPS. Sampled every 30 seconds.
*/
const char upsPhaseInputMaxCurrent[] = "9.2.3.1.7.1.1.1"; // r / int
// const char upsUnknown45[] = "9.2.3.1.7.1.1.2";
// const char upsUnknown46[] = "9.2.3.1.7.1.1.3";
/*
The minimum input current in 0.1 amperes measured since the last reset (upsPhaseResetMaxMinValues), or
-1 if it's unsupported by this UPS. Sampled every 30 seconds.
*/
const char upsPhaseInputMinCurrent[] = "9.2.3.1.8.1.1.1"; // r / int
// const char upsUnknown48[] = "9.2.3.1.8.1.1.2";
// const char upsUnknown49[] = "9.2.3.1.8.1.1.3";
/*
The input frequency in 0.1 Hertz, or -1 if it's unsupported by this UPS.
*/
const char upsPhaseInputFrequency[] = "9.2.2.1.4.1";     // r / int
/*
The current input frequency to the UPS system in tenths of Hz
*/
const char upsHighPrecInputFrequency[] = "3.3.4.0";      // r / gauge
/*
The current input frequency to the UPS system in Hz
*/
const char upsAdvInputFrequency[] = "3.2.4.0";           // r / gauge
/*
...
value is used
*/
const char upsAdvConfigLowTransferVolt[] = "5.2.3.0";    // rw / int
/*
...
value is used
*/
const char upsAdvConfigHighTransferVolt[] = "5.2.2.0";   // rw / int
/*
...
*/
const char upsAdvInputLineFailCause[] = "3.2.5.0";       // r / int
/*
...
- high          (4)
*/
const char upsAdvConfigSensitivity[] = "5.2.7.0";        // rw / int
/*
...
- onBatteryTest             (15)
*/
const char upsBasicOutputStatus[] = "4.1.1.0";           // r / int
/*
...
*/
const char upsBasicBatteryStatus[] = "2.1.1.0";          // r / int
/*
...
value is used
*/
const char upsAdvConfigShutoffDelay[] = "5.2.10.0";      // rw / timeTicks
/*
...
value is used
*/
const char upsAdvConfigReturnDelay[] = "5.2.9.0";        // rw / timeTicks
/*
The remaining battery capacity expressed in
tenths of percent of full capacity
*/
//  const char upsHighPrecBatteryCapacity[] = "2.3.1.0"; // r / gauge
/*
The remaining battery capacity expressed in percent of full capacity
*/
const char upsAdvBatteryCapacity[] = "2.2.1.0";          // r / gauge
/*
...
value is used
*/
const char upsAdvConfigMinReturnCapacity[] = "5.2.6.0";  // rw / int
/*
The UPS battery run time remaining before battery exhaustion
*/
const char upsAdvBatteryRunTimeRemaining[] = "2.2.3.0";  // r / timeTicks
/*
...
*/
const char upsAdvConfigLowBatteryRunTime[] = "5.2.8.0";  // rw / timeTicks
/*
The actual battery bus voltage in tenths of Volts
*/
//  const char upsHighPrecBatteryActualVoltage[] = "2.3.4.0"; // r / int
/*
The actual battery bus voltage in Volts
*/
const char upsAdvBatteryActualVoltage[] = "2.2.8.0";     // r / int
/*
The nominal battery voltage in Volts
*/
const char upsAdvBatteryNominalVoltage[] = "2.2.7.0";    // r / int
/*
The battery current in tenths of Amps
*/
//  const char upsHighPrecBatteryCurrent[] = "2.3.5.0"; // r / int
/*
The battery current in Amps
*/
const char upsAdvBatteryCurrent[] = "2.2.9.0";           // r / int
/*
The total DC current in tenths of Amps
*/
//  const char upsHighPrecTotalDCCurrent[] = "2.3.6.0"; // r / int
/*
The number of external battery packs connected to the UPS. If
the UPS does not use smart cells then the agent reports
ERROR_NO_SUCH_NAME
*/
const char upsAdvBatteryNumOfBattPacks[] = "2.2.5.0";    // r / int
/*
...
*/
const char upsAdvBatteryNumOfBadBattPacks[] = "2.2.6.0"; // r / int
/*
...
*/
const char upsBasicBatteryLastReplaceDate[] = "2.1.3.0"; // rw / string
/*
...
- testInProgress 	(4)
*/
const char upsAdvTestDiagnosticsResults[] = "7.2.3.0";   // r / int
/*
The date the last UPS diagnostics test was performed in
mm/dd/yy format
*/
const char upsAdvTestLastDiagnosticsDate[] = "7.2.4.0";  // r / string
/*
The output voltage of the UPS system in tenths of VAC
*/
const char upsHighPrecOutputVoltage[] = "4.3.1.0";       // r / gauge
/*
The output voltage of the UPS system in VAC
*/
const char upsAdvOutputVoltage[] = "4.2.1.0";            // r / gauge
/*
...
output phase table
*/
const char upsPhaseNumOutputPhases[] = "9.3.2.1.2.1";    // r / int
/*
The output frequency in 0.1 Hertz, or -1 if it's
unsupported by this UPS
*/
const char upsPhaseOutputFrequency[] = "9.3.2.1.4.1";    // r / int
/*
The current output frequency of the UPS system in tenths of Hz
*/
//  const char upsHighPrecOutputFrequency[] = "4.3.2.0"; // r / gauge
/*
The current output frequency of the UPS system in Hz
*/
const char upsAdvOutputFrequency[] = "4.2.2.0";          // r / gauge
/*
The current in tenths of amperes drawn by the load on the UPS
*/
//  const char upsHighPrecOutputCurrent[] = "4.3.4.0"; // r / gauge
/*
The current in amperes drawn by the load on the UPS
*/
const char upsAdvOutputCurrent[] = "4.2.4.0";            // r / gauge
/*
The output voltage in VAC, or -1 if it's unsupported by this UPS.
*/
const char upsPhaseOutputVoltage[] = "9.3.3.1.3.1.1.1"; // r / int
// const char upsUnknown02[] = "9.3.3.1.3.1.1.2";
// const char upsUnknown03[] = "9.3.3.1.3.1.1.3";
/*
The output current in 0.1 amperes drawn by the load on the UPS, or -1 if it's unsupported by this UPS.
*/
const char upsPhaseOutputCurrent[] = "9.3.3.1.4.1.1.1"; // r / int
// const char upsUnknown05[] = "9.3.3.1.4.1.1.2";
// const char upsUnknown06[] = "9.3.3.1.4.1.1.3";
/*
The maximum output current in 0.1 amperes measured since the last reset (upsPhaseResetMaxMinValues),
or -1 if it's unsupported by this UPS. Sampled every 30 seconds.
*/
const char upsPhaseOutputMaxCurrent[] = "9.3.3.1.5.1.1.1"; // r / int
// const char upsUnknown08[] = "9.3.3.1.5.1.1.2";
// const char upsUnknown09[] = "9.3.3.1.5.1.1.3";
/*
The minimum output current in 0.1 amperes measured since the last reset (upsPhaseResetMaxMinValues), or
-1 if it's unsupported by this UPS. Sampled every 30 seconds.
*/
const char upsPhaseOutputMinCurrent[] = "9.3.3.1.6.1.1.1"; // r / int
// const char upsUnknown11[] = "9.3.3.1.6.1.1.2";
// const char upsUnknown12[] = "9.3.3.1.6.1.1.3";
/*
The output load in VA, or -1 if it's unsupported by this UPS.
*/
const char upsPhaseOutputLoad[] = "9.3.3.1.7.1.1.1"; // r / int
// const char upsUnknown14[] = "9.3.3.1.7.1.1.2";
// const char upsUnknown15[] = "9.3.3.1.7.1.1.3";
/*
The maximum output load in VA measured since the last reset (upsPhaseResetMaxMinValues), or
-1 if it's unsupported by this UPS. Sampled every 30 seconds.
*/
const char upsPhaseOutputMaxLoad[] = "9.3.3.1.8.1.1.1"; // r / int
// const char upsUnknown17[] = "9.3.3.1.8.1.1.2";
// const char upsUnknown18[] = "9.3.3.1.8.1.1.3";
/*
The minimum output load in VA measured since the last reset (upsPhaseResetMaxMinValues), or
-1 if it's unsupported by this UPS. Sampled every 30 seconds.
*/
const char upsPhaseOutputMinLoad[] = "9.3.3.1.9.1.1.1"; // r / int
// const char upsUnknown20[] = "9.3.3.1.9.1.1.2";
// const char upsUnknown21[] = "9.3.3.1.9.1.1.3";
/*
...
*/
const char upsPhaseOutputPercentLoad[] = "9.3.3.1.10.1.1.1"; // r / int
// const char upsUnknown23[] = "9.3.3.1.10.1.1.2";
// const char upsUnknown24[] = "9.3.3.1.10.1.1.3";
/*
...
*/
const char upsPhaseOutputMaxPercentLoad[] = "9.3.3.1.11.1.1.1"; // r / int
// const char upsUnknown26[] = "9.3.3.1.11.1.1.2";
// const char upsUnknown27[] = "9.3.3.1.11.1.1.3";
/*
...
*/
const char upsPhaseOutputMinPercentLoad[] = "9.3.3.1.12.1.1.1"; // r / int
// const char upsUnknown29[] = "9.3.3.1.12.1.1.2";
// const char upsUnknown30[] = "9.3.3.1.12.1.1.3";
...
value is used.
*/
const char upsAdvConfigRatedOutputVoltage[] = "5.2.1.0"; // rw / int

/*
The relative humidity as a percentage for Probe 1
*/
const char mUpsEnvironRelativeHumidity[] = "2.1.2.0"; // r / gauge
/*
The ambient temperature in Celsius for Probe 1
*/
const char mUpsEnvironAmbientTemperature[] = "2.1.1.0"; // r / gauge
...
const char upsDiagBatteryStatus[] = "13.3"; // r / int
...
const char oidEmterpriseEm[] = ".1.3.6.1.4.1.38.1.1.10.";
/*
...
*/
const char emConfigProbeHighTempThreshold[] = "1.2.2.1.3.1"; // rw / int
/*
...
*/
const char emConfigProbeLowTempThreshold[] = "1.2.2.1.4.1"; // rw / int
/*
The high humidity alarm threshold for the probe in percent relative humidity.
*/
const char emConfigProbeHighHumidThreshold[] = "1.2.2.1.6.1"; // rw / int
/*
The low humidity alarm threshold for the probe in percent relative humidity
*/
const char emConfigProbeLowHumidThreshold[] = "1.2.2.1.7.1"; // rw / int
/*
...
*/
const char iemStatusProbeCurrentTemp[] = "2.3.2.1.4.1"; // r / int
/*
The current humidity reading from the probe in percent relative humidity
*/
const char iemStatusProbeCurrentHumid[] = "2.3.2.1.6.1"; // r / int
